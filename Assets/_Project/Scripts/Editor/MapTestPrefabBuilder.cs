...
public static class MapTestPrefabBuilder
{
    ...
    private static void CreatePrefabIfMissing(string prefabName, MapPieceType pieceType, Vector3 size, Material material, Mesh mesh)
    {
        ...
        serializedMapPiece.FindProperty("pieceType").enumValueIndex = (int)pieceType;
        serializedMapPiece.FindProperty("useCollider").boolValue = true;
        serializedMapPiece.FindProperty("blockMovement").boolValue = true;
        serializedMapPiece.FindProperty("blockLineOfSight").boolValue = true;
        serializedMapPiece.FindProperty("autoSetObstacleLayer").boolValue = true;
        serializedMapPiece.FindProperty("obstacleLayerName").stringValue = ObstacleLayerName;
