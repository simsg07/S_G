...
public abstract class MonsterAIBase : MonoBehaviour
{
    ...
    [SerializeField] protected bool useSeparateLightObstacleMask;
    [SerializeField] protected LayerMask lightObstacleLayerMask;
    ...
    protected virtual void ApplyFunctionalComponentSettings()
    {
        ...
        if (monsterDetection != null)
        {
            ...
            useSeparateLightObstacleMask = monsterDetection.useSeparateLightObstacleMask;
            lightObstacleLayerMask = monsterDetection.lightObstacleLayerMask;
    ...
    {
        return HasLineOfSightTo(target, GetObstacleMaskForTarget(target));
    }
    ...
    private LayerMask GetObstacleMaskForTarget(Transform target)
    {
        bool isLightTarget = target != null &&
            (target == lightTarget || (currentTargetType == MonsterTargetType.Light && target == currentTarget));
    ...
    private void LogInitialDebugInfo()
    {
        ...
        Debug.Log(
            ...
            $"ObstacleMask={obstacleLayerMask.value}, LightObstacleMask={lightObstacleLayerMask.value}, MovementObstacleMask={movementObstacleLayerMask.value}, GroundMask={groundLayerMask.value}, FixedZ={fixedZPosition:0.###}",
            this);
